...
const getBulletByUsingBulletStorage = (bulletStorage) => {
  ...
  const { bucket: bucketName, bkGuid, googleStorage } = bulletStorage;
  const iamJsonFilePath = `./uploads/${bkGuid}/${googleStorage.keyfilename}`;
...
const uploadImageToGCS = (file, storage, name) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      const iamJsonFilePath = `./uploads/${storage.bkGuid}/${storage.googleStorage.keyfilename}`;
